...
try:
    ...
    try:
        from decklister.app_paths import get_image_cache_dir   # run from the project root
    except ImportError:
        from app_paths import get_image_cache_dir         # run directly inside the package folder
...
if __name__ == "__main__":
    ...
    # --update / --download imply the check, so `--download` on its own works.
        ...
        print("Usage:")
        print("  python image_downloader.py <card_set> [<card_number>]")
        print("  python image_downloader.py --all")
        print("  python image_downloader.py --check      # report only")
        print("  python image_downloader.py --update     # report + save manifest")
        print("  python image_downloader.py --download   # + fetch new cards")
        print("  python image_downloader.py --history [N] [--detail]")
        print("")

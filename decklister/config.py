...
class Config:
    def __init__(self, resolution=(1920, 1080), forbidden_areas=None, background=None,
                 foreground=None, leader_areas=None, base_area=None, deck_area=None, sb_area=None, count_background=None):
        ...
        self.leader_areas = leader_areas  # list of up to two lists like [x0, y0, x1, y1] or None
        ...
        if self.leader_areas:
            for area in self.leader_areas:
